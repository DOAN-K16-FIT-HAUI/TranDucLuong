...
class TransactionScreenState extends State<TransactionScreen> {
  ...
  String _mapLocalizedTypeToKey(String localizedType, AppLocalizations l10n) {
    ...
    return localizedType; // Fallback, nhưng lý tưởng không nên xảy ra
  }
  ...
  void _saveTransaction() {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final transaction = TransactionModel(
        ...
        amount: amount,
        date: _selectedDate,
        typeKey: _mapLocalizedTypeToKey(_selectedType, l10n), // Ánh xạ sang key cố định
        category: _selectedType == l10n.transactionTypeExpense ? _selectedCategory : '',
